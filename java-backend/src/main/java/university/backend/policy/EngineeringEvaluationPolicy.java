...
public class EngineeringEvaluationPolicy implements EvaluationPolicy {
    @Override
...
return count == 0 ? 0.0 : GradeScale.round2(sum / count);
    ...
    public String getPolicyName() {
        return "Engineering Simple Average";
    }

    @Override
    public String getDescription() {
        return "Engineering uses an equal-weight mean of 4.0-scale course GPA values.";
    }
