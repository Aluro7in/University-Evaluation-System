...
public class GraduateEvaluationPolicy implements EvaluationPolicy {
    @Override
...
return credits == 0 ? 0.0 : GradeScale.round2(weightedPoints / credits);
    ...
    public String getPolicyName() {
        return "Graduate Credit Weighted Average";
    }

    @Override
    public String getDescription() {
        return "Graduate programs use credit weighting while requiring explicit finalization for official transcripts.";
    }
